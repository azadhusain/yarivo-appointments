...
- Name: edge\edge-registration-auth.spec.js >> @edge Registration & Authentication Edge Cases >> should reject invalid currency codes
- Location: tests\edge\edge-registration-auth.spec.js:42:3
